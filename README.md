...
| Страница | Дизайн | Верстка mobile | Верстка mobile landscape | Верстка desktop | Тесты |
|:--------|:------:|:-------:|:-----:|:-------:|:-----:|
...
| Лицензия (файл) | :heavy_minus_sign: | :white_check_mark: | :white_check_mark: | :white_check_mark: | :heavy_minus_sign: |
| Пользовательское соглашение (файл) | :heavy_minus_sign: | :white_large_square: | :white_large_square: | :white_large_square: | :heavy_minus_sign: |
| Политика конфиденциальности (файл) | :heavy_minus_sign: | :white_large_square: | :white_large_square: | :white_large_square: | :heavy_minus_sign: |
